        ...
        return {
                ...
                sendMessage: async(
                        ...
                        if(
                                ...
                                //CF \/ Patched: detect appStateSyncKeyRequest to use peer category
                                const isAppStateSyncKeyRequest = 'appStateSyncKeyRequest' in content && !!(content as any).appStateSyncKeyRequest
                                //CF /\
                                ...
                                //CF \/ Patched: appStateSyncKeyRequest must be sent as a peer message
                                // (category: 'peer', push_priority: 'high_force') just like
                                // sendPeerDataOperationMessage does. Without these attributes the
                                // server does not respond with APP_STATE_SYNC_KEY_SHARE.
                                if(isAppStateSyncKeyRequest) {
                                        additionalAttributes.category = 'peer'
                                        additionalAttributes.push_priority = 'high_force'
                                }
                                //CF /\
